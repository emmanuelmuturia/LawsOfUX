...
class LocalBookSourceImplementation(
    ...
    private val localBookLessons =
        listOf(
            LocalBookLesson(
                localBookLessonDescription =
                    "How aesthetically pleasing design creates positive " +
                        "responses",
            ),
            LocalBookLesson(
            ...
            LocalBookLesson(
                localBookLessonDescription =
                    "Predictive models including Fitts's law, Jakob's law, " +
                        "and Hick's law",
            ),
            LocalBookLesson(
                localBookLessonDescription =
                    "A practical framework for applying principles of " +
    ...
    private val localBookReviews =
        listOf(
            LocalBookReview(
                localBookReviewCaption =
                    "The Laws of UX serves as an excellent resource for both " +
            ...
            LocalBookReview(
                localBookReviewCaption =
                    "This is the book I didn’t know I needed at the start of my " +
                        "career and the one I insist on for my students and staff.",
                localBookReviewAuthor = "ANDRES CURREY ZAPATA, D.SC.",
            ),
            LocalBookReview(
                localBookReviewCaption =
                    "Jon has broken down common psychology principles in a way " +
    ...
    private val localBookGalleries =
        listOf(
            LocalBookGallery(
    ...
    private val localBookSecondEditions =
        listOf(
    ...
    private val localBookFirstEditions =
        listOf(
    ...
    private val localBookTranslatedSecondEditions =
        listOf(
    ...
    private val localBookTranslatedFirstEditions =
        listOf(

...
class LocalArticleSourceImplementation(
    ...
    private val localArticles = listOf(
        LocalArticle(
            localArticleTitle = "Familiar vs Novel",
            localArticleDescription = "A look into when it’s acceptable and perhaps even " +
            ...
            localArticleDescription = "Onboarding should be designed with active users in mind, " +
            ...
            localArticleDescription = "For any system there is a certain amount of complexity " +
            ...
            localArticleDescription = "Why designers should pay close attention to the key peak " +
            ...
            localArticleDescription = "A look at how designers can leverage psychology to build " +
            ...
            localArticleDescription = "How a classic problem-solving principle can help " +
                "improve our designs.",
            ...
            localArticleDescription = "A look at both the causes and ways to reduce " +
